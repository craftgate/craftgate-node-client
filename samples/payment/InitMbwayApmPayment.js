...
const request = {
    apmType: Craftgate.Model.ApmType.PaylandsMbWay,
    price: 1.0,
    paidPrice: 1.0,
...
craftgate.payment().initApmPayment(request)
    .then(result => console.info('Paylands - MB WAY Apm init payment successful', result))
    .catch(err => console.error('Failed to init Paylands - MB WAY Apm payment', err));
