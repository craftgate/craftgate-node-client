...
const request = {
  ...
  additionalParams: {"cardNumber": "7599640961180814"}
};

craftgate.payment().initApmPayment(request)
  .then(result => console.info('Setcard Apm init payment successful', result))
  .catch(err => console.error('Failed to init Setcard Apm payment', err));
